...
def download_zip_file(version=None):
    if version is None:
        zip_file_url = "https://github.com/jcjaskula-aws/amazon-braket-sdk-python/zipball/jcjaskula-aws/add_cheat_sheet"
    else:
        zip_file_url = f"https://github.com/jcjaskula-aws/amazon-braket-sdk-python/archive/refs/tags/v{version}.zip"
